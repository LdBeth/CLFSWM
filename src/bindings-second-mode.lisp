...
(defun set-default-second-keys ()
  ...
  (define-second-key ("Right" :mod-4 :shift) 'select-next-brother-take-current)
  (define-second-key ("Left" :mod-4 :shift) 'select-previous-brother-take-current)
  ...
  (define-second-key ("Left" :control :mod-4 :shift) 'select-brother-spatial-move-left-take-current)
  (define-second-key ("Right" :control :mod-4 :shift) 'select-brother-spatial-move-right-take-current)
  (define-second-key ("Up" :control :mod-4 :shift) 'select-brother-spatial-move-up-take-current)
  (define-second-key ("Down" :control :mod-4 :shift) 'select-brother-spatial-move-down-take-current)
  ...
  (define-second-key ("F12" :shift :mod-4) 'show-all-frames-info)
